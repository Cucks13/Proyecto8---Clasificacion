...
class GestionOutliersUnivariados:
    ...
    def detectar_outliers_z_score(self):
        ...
        for columna in self._separar_variables_tipo()[0].columns:
            ...
            if diccionario_resultados_z[columna].shape[0] != 0:
...
class GestionOutliersMultivariados:
    ...
    def explorar_outliers_lof(self, var_dependiente, indice_contaminacion=[0.01, 0.05, 0.1], vecinos=[600, 1200], colores={-1: "red", 1: "grey"}, tamaño_grafica=(20, 15)):
        """
        ...
        for combinacion in combinaciones:
            ...
            fig, axes = plt.subplots(num_filas, 2, figsize=tamaño_grafica)
            axes = axes.flat
    ...
    def explorar_outliers_if(self, var_dependiente, indice_contaminacion=[0.01, 0.05, 0.1], estimadores=1000, colores={-1: "red", 1: "grey"}, tamaño_grafica=(20, 15)):
        """
