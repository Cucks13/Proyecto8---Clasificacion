...
def exploracion_datos(dataframe):
    ...
    display((dataframe_nulos[dataframe_nulos.values >0] / dataframe.shape[0]) * 100) # type: ignore

    print("\n----------\n")
    print("Las principales estadísticas de las variables númericas son:")
    display(dataframe.describe().T) # type: ignore

    print("\n----------\n")
    print("Las principales estadísticas de las variables categóricas son:")
    display(dataframe.describe(include = "O").T) # type: ignore

    print("\n----------\n")
    print("Las características principales del dataframe son:")
    display(dataframe.info()) # type: ignore
